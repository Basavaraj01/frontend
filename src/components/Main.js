...
class Main extends React.Component {
    ...
    async getOptions() {
        const res = await axios.get('http://ec2-3-88-173-140.compute-1.amazonaws.com:8093/product')
        const data = res.data
    ...
    getBuyers = (e) => {
        ...
        axios.get(`http://ec2-3-88-173-140.compute-1.amazonaws.com:8093/seller/show-bids/${id}`)
            .then(res => {
